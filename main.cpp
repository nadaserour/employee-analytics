...
#include "cmake-build-debug/Queries.h"
using namespace std;
...
int main()
{
    ...
    double age1= node1->getEmployee().age;
    double income1= node1->getEmployee().income;
    double performance1= node1->getEmployee().performance;
